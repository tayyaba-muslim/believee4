                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                            <div class="form-floating mb-3">
                                <input type="email" name="log_email" class="form-control" id="floatingInput" placeholder="name@example.com">
                            ...
                            <!-- </div> -->
                            <button type="submit" class="btn btn-primary py-3 w-100 mb-4" name="login" for="login">Sign In</button>
